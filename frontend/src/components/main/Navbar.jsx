...
import useAppContext from "../../context/AppContext";
  ...
  //   if (setting.onClick) {
  //     setting.onClick(logout, navigate); // If onClick is defined, call it
  //     logout();
  //   } else {
  //     navigate(setting.link); // Otherwise, navigate to the specified link
  //   }
  // };
...
//                     textAlign="center"
//                     onClick={() =>
//                       setting.onClick ? setting.onClick(logout, navigate) : null
//                     }
//                   >
//                     {setting.text}
//                   </Typography>
        ...
        {loggedIn ? (
          ...
          <Box sx={{ flexGrow: 0, display: "flex", justifyContent: "flex-end" }}>
            <Button
              ...
              sx={{ ml: 1, borderRadius: 5, textTransform: "none", fontSize: "18px",textShadow: "2px 2px 4px rgba(0, 0, 0, 0.8)",
